...
import WasteReportingHub from './components/sections/WasteReportingHub';
import OperationsHub from './components/sections/OperationsHub';
...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'reportWaste': return <WasteReportingHub language={language} />;
      case 'rewards': return <WasteReportingHub language={language} initialSubTab="rewards" />;
      case 'studio': return <WasteReportingHub language={language} />;
      case 'operations': return <OperationsHub language={language} />;
